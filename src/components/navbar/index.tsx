...
export function NavBar({options}: NavBarProps) {
    return (
        <nav className='flex flex-col items-center justify-center gap-2 py-4 lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-full lg:flex-row lg:justify-between lg:py-4 max-w-7xl mx-auto bg-white'>
